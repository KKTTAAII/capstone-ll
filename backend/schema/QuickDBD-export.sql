...
CREATE TABLE `shelters_asoptable_dogs` (
    `id` serial  NULL ,
    `shelter_id` int  NOT NULL ,
    `adopatble_dogs_id` int  NOT NULL 
);
...
ALTER TABLE `shelters_asoptable_dogs` ADD CONSTRAINT `fk_shelters_asoptable_dogs_shelter_id` FOREIGN KEY(`shelter_id`)
REFERENCES `shelters` (`id`);

ALTER TABLE `shelters_asoptable_dogs` ADD CONSTRAINT `fk_shelters_asoptable_dogs_adopatble_dogs_id` FOREIGN KEY(`adopatble_dogs_id`)
